...
SRCS = main.c push_swap.c errors.c utils.c fast_sort.c algorithm.c \
...
DIR_SRC_B = ./bonus
DIR_OBJ_B = $(DIR_SRCS_B)/obj
OBJ_B = $(addprefix $(DIR_OBJ_B)/, $(SRCS_B:.c=.o))
DEP_B = $(addprefix $(DIR_OBJ_B)/, $(SRCS_B:.c=.d))
NAME_B = checker
